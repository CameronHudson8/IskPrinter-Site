...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EveSwaggerInterface.GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo();
  });
  ...
  describe('GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo', function() {
    it('should create an instance of GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo', function() {
      // uncomment below and update the code to test GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo
      //var instane = new EveSwaggerInterface.GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo();
      //expect(instance).to.be.a(EveSwaggerInterface.GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo);
    });
