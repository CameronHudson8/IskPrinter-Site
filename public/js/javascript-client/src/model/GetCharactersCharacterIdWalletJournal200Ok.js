...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetCharactersCharacterIdWalletJournalExtraInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetCharactersCharacterIdWalletJournalExtraInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.GetCharactersCharacterIdWalletJournal200Ok = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.GetCharactersCharacterIdWalletJournalExtraInfo);
  }
}(this, function(ApiClient, GetCharactersCharacterIdWalletJournalExtraInfo) {
  'use strict';
   ...
   * @param refType {module:model/GetCharactersCharacterIdWalletJournal200Ok.RefTypeEnum} Transaction type, different type of transaction will populate different fields in `extra_info` Note: If you have an existing XML API application that is using ref_types, you will need to know which string ESI ref_type maps to which integer. You can use the following gist to see string->int mappings: https://gist.github.com/ccp-zoetrope/c03db66d90c2148724c06171bc52e0ec
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('extra_info')) {
        obj['extra_info'] = GetCharactersCharacterIdWalletJournalExtraInfo.constructFromObject(data['extra_info']);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/GetCharactersCharacterIdWalletJournal200Ok.FirstPartyTypeEnum} first_party_type
   */
   ...
   * @member {module:model/GetCharactersCharacterIdWalletJournal200Ok.SecondPartyTypeEnum} second_party_type
   */
  ...
  /**
   * @member {module:model/GetCharactersCharacterIdWalletJournalExtraInfo} extra_info
   */
