...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveSwaggerInterface.GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo = factory(root.EveSwaggerInterface.ApiClient);
  }
  ...
  /**
   * The GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo model module.
   * @module model/GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo
   * @version 0.7.6
   */

  /**
   * Constructs a new <code>GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo</code>.
   * Extra information for different type of transaction
   * @alias module:model/GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo
   * @class
   */
  ...
  /**
   * Constructs a <code>GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo} obj Optional instance to populate.
   * @return {module:model/GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo} The populated <code>GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo</code> instance.
   */
