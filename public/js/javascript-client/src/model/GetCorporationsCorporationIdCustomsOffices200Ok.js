...
(function(root, factory) {
   ...
   */
  var exports = function(officeId, systemId, reinforceExitStart, reinforceExitEnd, allowAllianceAccess, allowAccessWithStandings) {
    var _this = this;

    _this['office_id'] = officeId;
    _this['system_id'] = systemId;
    _this['reinforce_exit_start'] = reinforceExitStart;
    _this['reinforce_exit_end'] = reinforceExitEnd;

    _this['allow_alliance_access'] = allowAllianceAccess;

    _this['allow_access_with_standings'] = allowAccessWithStandings;
