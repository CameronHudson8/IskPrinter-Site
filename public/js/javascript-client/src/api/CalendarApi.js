...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Forbidden', 'model/GetCharactersCharacterIdCalendar200Ok', 'model/GetCharactersCharacterIdCalendarEventIdAttendees200Ok', 'model/GetCharactersCharacterIdCalendarEventIdOk', 'model/InternalServerError', 'model/PutCharactersCharacterIdCalendarEventIdResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Forbidden'), require('../model/GetCharactersCharacterIdCalendar200Ok'), require('../model/GetCharactersCharacterIdCalendarEventIdAttendees200Ok'), require('../model/GetCharactersCharacterIdCalendarEventIdOk'), require('../model/InternalServerError'), require('../model/PutCharactersCharacterIdCalendarEventIdResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.CalendarApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.Forbidden, root.EveSwaggerInterface.GetCharactersCharacterIdCalendar200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdCalendarEventIdAttendees200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdCalendarEventIdOk, root.EveSwaggerInterface.InternalServerError, root.EveSwaggerInterface.PutCharactersCharacterIdCalendarEventIdResponse);
  }
}(this, function(ApiClient, Forbidden, GetCharactersCharacterIdCalendar200Ok, GetCharactersCharacterIdCalendarEventIdAttendees200Ok, GetCharactersCharacterIdCalendarEventIdOk, InternalServerError, PutCharactersCharacterIdCalendarEventIdResponse) {
  'use strict';
