...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetSovereigntyCampaigns200Ok', 'model/GetSovereigntyMap200Ok', 'model/GetSovereigntyStructures200Ok', 'model/InternalServerError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GetSovereigntyCampaigns200Ok'), require('../model/GetSovereigntyMap200Ok'), require('../model/GetSovereigntyStructures200Ok'), require('../model/InternalServerError'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.SovereigntyApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.GetSovereigntyCampaigns200Ok, root.EveSwaggerInterface.GetSovereigntyMap200Ok, root.EveSwaggerInterface.GetSovereigntyStructures200Ok, root.EveSwaggerInterface.InternalServerError);
  }
}(this, function(ApiClient, GetSovereigntyCampaigns200Ok, GetSovereigntyMap200Ok, GetSovereigntyStructures200Ok, InternalServerError) {
  'use strict';
