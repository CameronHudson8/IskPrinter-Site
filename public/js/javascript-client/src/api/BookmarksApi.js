...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Forbidden', 'model/GetCharactersCharacterIdBookmarks200Ok', 'model/GetCharactersCharacterIdBookmarksFolders200Ok', 'model/GetCorporationsCorporationIdBookmarks200Ok', 'model/GetCorporationsCorporationIdBookmarksFolders200Ok', 'model/InternalServerError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Forbidden'), require('../model/GetCharactersCharacterIdBookmarks200Ok'), require('../model/GetCharactersCharacterIdBookmarksFolders200Ok'), require('../model/GetCorporationsCorporationIdBookmarks200Ok'), require('../model/GetCorporationsCorporationIdBookmarksFolders200Ok'), require('../model/InternalServerError'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.BookmarksApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.Forbidden, root.EveSwaggerInterface.GetCharactersCharacterIdBookmarks200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdBookmarksFolders200Ok, root.EveSwaggerInterface.GetCorporationsCorporationIdBookmarks200Ok, root.EveSwaggerInterface.GetCorporationsCorporationIdBookmarksFolders200Ok, root.EveSwaggerInterface.InternalServerError);
  }
}(this, function(ApiClient, Forbidden, GetCharactersCharacterIdBookmarks200Ok, GetCharactersCharacterIdBookmarksFolders200Ok, GetCorporationsCorporationIdBookmarks200Ok, GetCorporationsCorporationIdBookmarksFolders200Ok, InternalServerError) {
  'use strict';
