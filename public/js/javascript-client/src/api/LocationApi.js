...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Forbidden', 'model/GetCharactersCharacterIdLocationOk', 'model/GetCharactersCharacterIdOnlineOk', 'model/GetCharactersCharacterIdShipOk', 'model/InternalServerError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Forbidden'), require('../model/GetCharactersCharacterIdLocationOk'), require('../model/GetCharactersCharacterIdOnlineOk'), require('../model/GetCharactersCharacterIdShipOk'), require('../model/InternalServerError'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.LocationApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.Forbidden, root.EveSwaggerInterface.GetCharactersCharacterIdLocationOk, root.EveSwaggerInterface.GetCharactersCharacterIdOnlineOk, root.EveSwaggerInterface.GetCharactersCharacterIdShipOk, root.EveSwaggerInterface.InternalServerError);
  }
}(this, function(ApiClient, Forbidden, GetCharactersCharacterIdLocationOk, GetCharactersCharacterIdOnlineOk, GetCharactersCharacterIdShipOk, InternalServerError) {
  'use strict';
