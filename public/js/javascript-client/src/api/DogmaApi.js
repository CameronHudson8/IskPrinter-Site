...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetDogmaAttributesAttributeIdNotFound', 'model/GetDogmaAttributesAttributeIdOk', 'model/GetDogmaEffectsEffectIdNotFound', 'model/GetDogmaEffectsEffectIdOk', 'model/InternalServerError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GetDogmaAttributesAttributeIdNotFound'), require('../model/GetDogmaAttributesAttributeIdOk'), require('../model/GetDogmaEffectsEffectIdNotFound'), require('../model/GetDogmaEffectsEffectIdOk'), require('../model/InternalServerError'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.DogmaApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.GetDogmaAttributesAttributeIdNotFound, root.EveSwaggerInterface.GetDogmaAttributesAttributeIdOk, root.EveSwaggerInterface.GetDogmaEffectsEffectIdNotFound, root.EveSwaggerInterface.GetDogmaEffectsEffectIdOk, root.EveSwaggerInterface.InternalServerError);
  }
}(this, function(ApiClient, GetDogmaAttributesAttributeIdNotFound, GetDogmaAttributesAttributeIdOk, GetDogmaEffectsEffectIdNotFound, GetDogmaEffectsEffectIdOk, InternalServerError) {
  'use strict';
