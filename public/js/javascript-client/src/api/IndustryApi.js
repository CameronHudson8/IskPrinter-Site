...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Forbidden', 'model/GetCharactersCharacterIdIndustryJobs200Ok', 'model/GetCharactersCharacterIdMining200Ok', 'model/GetCorporationCorporationIdMiningExtractions200Ok', 'model/GetCorporationCorporationIdMiningObservers200Ok', 'model/GetCorporationCorporationIdMiningObserversObserverId200Ok', 'model/GetCorporationsCorporationIdIndustryJobs200Ok', 'model/GetIndustryFacilities200Ok', 'model/GetIndustrySystems200Ok', 'model/InternalServerError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Forbidden'), require('../model/GetCharactersCharacterIdIndustryJobs200Ok'), require('../model/GetCharactersCharacterIdMining200Ok'), require('../model/GetCorporationCorporationIdMiningExtractions200Ok'), require('../model/GetCorporationCorporationIdMiningObservers200Ok'), require('../model/GetCorporationCorporationIdMiningObserversObserverId200Ok'), require('../model/GetCorporationsCorporationIdIndustryJobs200Ok'), require('../model/GetIndustryFacilities200Ok'), require('../model/GetIndustrySystems200Ok'), require('../model/InternalServerError'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.IndustryApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.Forbidden, root.EveSwaggerInterface.GetCharactersCharacterIdIndustryJobs200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdMining200Ok, root.EveSwaggerInterface.GetCorporationCorporationIdMiningExtractions200Ok, root.EveSwaggerInterface.GetCorporationCorporationIdMiningObservers200Ok, root.EveSwaggerInterface.GetCorporationCorporationIdMiningObserversObserverId200Ok, root.EveSwaggerInterface.GetCorporationsCorporationIdIndustryJobs200Ok, root.EveSwaggerInterface.GetIndustryFacilities200Ok, root.EveSwaggerInterface.GetIndustrySystems200Ok, root.EveSwaggerInterface.InternalServerError);
  }
}(this, function(ApiClient, Forbidden, GetCharactersCharacterIdIndustryJobs200Ok, GetCharactersCharacterIdMining200Ok, GetCorporationCorporationIdMiningExtractions200Ok, GetCorporationCorporationIdMiningObservers200Ok, GetCorporationCorporationIdMiningObserversObserverId200Ok, GetCorporationsCorporationIdIndustryJobs200Ok, GetIndustryFacilities200Ok, GetIndustrySystems200Ok, InternalServerError) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.datasource The server name you would like data from (default to tranquility)
     * @param {Boolean} opts.includeCompleted Whether retrieve completed industry jobs as well (default to false)
     * @param {Number} opts.page Which page of results to return (default to 1)
     * @param {String} opts.token Access token to use if unable to set a header
     * @param {String} opts.userAgent Client identifier, takes precedence over headers
     * @param {String} opts.xUserAgent Client identifier, takes precedence over User-Agent
