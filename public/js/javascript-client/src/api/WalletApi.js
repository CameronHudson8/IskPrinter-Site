...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Forbidden', 'model/GetCharactersCharacterIdWalletJournal200Ok', 'model/GetCharactersCharacterIdWalletTransactions200Ok', 'model/GetCorporationsCorporationIdWallets200Ok', 'model/GetCorporationsCorporationIdWalletsDivisionJournal200Ok', 'model/GetCorporationsCorporationIdWalletsDivisionTransactions200Ok', 'model/InternalServerError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Forbidden'), require('../model/GetCharactersCharacterIdWalletJournal200Ok'), require('../model/GetCharactersCharacterIdWalletTransactions200Ok'), require('../model/GetCorporationsCorporationIdWallets200Ok'), require('../model/GetCorporationsCorporationIdWalletsDivisionJournal200Ok'), require('../model/GetCorporationsCorporationIdWalletsDivisionTransactions200Ok'), require('../model/InternalServerError'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.WalletApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.Forbidden, root.EveSwaggerInterface.GetCharactersCharacterIdWalletJournal200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdWalletTransactions200Ok, root.EveSwaggerInterface.GetCorporationsCorporationIdWallets200Ok, root.EveSwaggerInterface.GetCorporationsCorporationIdWalletsDivisionJournal200Ok, root.EveSwaggerInterface.GetCorporationsCorporationIdWalletsDivisionTransactions200Ok, root.EveSwaggerInterface.InternalServerError);
  }
}(this, function(ApiClient, Forbidden, GetCharactersCharacterIdWalletJournal200Ok, GetCharactersCharacterIdWalletTransactions200Ok, GetCorporationsCorporationIdWallets200Ok, GetCorporationsCorporationIdWalletsDivisionJournal200Ok, GetCorporationsCorporationIdWalletsDivisionTransactions200Ok, InternalServerError) {
  'use strict';
