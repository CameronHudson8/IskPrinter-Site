...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetWarsWarIdKillmails200Ok', 'model/GetWarsWarIdKillmailsUnprocessableEntity', 'model/GetWarsWarIdOk', 'model/GetWarsWarIdUnprocessableEntity', 'model/InternalServerError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GetWarsWarIdKillmails200Ok'), require('../model/GetWarsWarIdKillmailsUnprocessableEntity'), require('../model/GetWarsWarIdOk'), require('../model/GetWarsWarIdUnprocessableEntity'), require('../model/InternalServerError'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.WarsApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.GetWarsWarIdKillmails200Ok, root.EveSwaggerInterface.GetWarsWarIdKillmailsUnprocessableEntity, root.EveSwaggerInterface.GetWarsWarIdOk, root.EveSwaggerInterface.GetWarsWarIdUnprocessableEntity, root.EveSwaggerInterface.InternalServerError);
  }
}(this, function(ApiClient, GetWarsWarIdKillmails200Ok, GetWarsWarIdKillmailsUnprocessableEntity, GetWarsWarIdOk, GetWarsWarIdUnprocessableEntity, InternalServerError) {
  'use strict';
