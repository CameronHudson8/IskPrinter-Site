...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Forbidden', 'model/GetCharactersCharacterIdAssets200Ok', 'model/GetCorporationsCorporationIdAssets200Ok', 'model/InternalServerError', 'model/PostCharactersCharacterIdAssetsLocations200Ok', 'model/PostCharactersCharacterIdAssetsNames200Ok', 'model/PostCorporationsCorporationIdAssetsLocations200Ok', 'model/PostCorporationsCorporationIdAssetsNames200Ok'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Forbidden'), require('../model/GetCharactersCharacterIdAssets200Ok'), require('../model/GetCorporationsCorporationIdAssets200Ok'), require('../model/InternalServerError'), require('../model/PostCharactersCharacterIdAssetsLocations200Ok'), require('../model/PostCharactersCharacterIdAssetsNames200Ok'), require('../model/PostCorporationsCorporationIdAssetsLocations200Ok'), require('../model/PostCorporationsCorporationIdAssetsNames200Ok'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.AssetsApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.Forbidden, root.EveSwaggerInterface.GetCharactersCharacterIdAssets200Ok, root.EveSwaggerInterface.GetCorporationsCorporationIdAssets200Ok, root.EveSwaggerInterface.InternalServerError, root.EveSwaggerInterface.PostCharactersCharacterIdAssetsLocations200Ok, root.EveSwaggerInterface.PostCharactersCharacterIdAssetsNames200Ok, root.EveSwaggerInterface.PostCorporationsCorporationIdAssetsLocations200Ok, root.EveSwaggerInterface.PostCorporationsCorporationIdAssetsNames200Ok);
  }
}(this, function(ApiClient, Forbidden, GetCharactersCharacterIdAssets200Ok, GetCorporationsCorporationIdAssets200Ok, InternalServerError, PostCharactersCharacterIdAssetsLocations200Ok, PostCharactersCharacterIdAssetsNames200Ok, PostCorporationsCorporationIdAssetsLocations200Ok, PostCorporationsCorporationIdAssetsNames200Ok) {
  'use strict';
