...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Forbidden', 'model/GetCharactersCharacterIdAgentsResearch200Ok', 'model/GetCharactersCharacterIdBlueprints200Ok', 'model/GetCharactersCharacterIdChatChannels200Ok', 'model/GetCharactersCharacterIdCorporationhistory200Ok', 'model/GetCharactersCharacterIdFatigueOk', 'model/GetCharactersCharacterIdMedals200Ok', 'model/GetCharactersCharacterIdNotFound', 'model/GetCharactersCharacterIdNotifications200Ok', 'model/GetCharactersCharacterIdNotificationsContacts200Ok', 'model/GetCharactersCharacterIdOk', 'model/GetCharactersCharacterIdPortraitNotFound', 'model/GetCharactersCharacterIdPortraitOk', 'model/GetCharactersCharacterIdRolesOk', 'model/GetCharactersCharacterIdStandings200Ok', 'model/GetCharactersCharacterIdStats200Ok', 'model/GetCharactersCharacterIdTitles200Ok', 'model/GetCharactersNames200Ok', 'model/InternalServerError', 'model/PostCharactersAffiliation200Ok', 'model/PostCharactersAffiliationNotFound'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Forbidden'), require('../model/GetCharactersCharacterIdAgentsResearch200Ok'), require('../model/GetCharactersCharacterIdBlueprints200Ok'), require('../model/GetCharactersCharacterIdChatChannels200Ok'), require('../model/GetCharactersCharacterIdCorporationhistory200Ok'), require('../model/GetCharactersCharacterIdFatigueOk'), require('../model/GetCharactersCharacterIdMedals200Ok'), require('../model/GetCharactersCharacterIdNotFound'), require('../model/GetCharactersCharacterIdNotifications200Ok'), require('../model/GetCharactersCharacterIdNotificationsContacts200Ok'), require('../model/GetCharactersCharacterIdOk'), require('../model/GetCharactersCharacterIdPortraitNotFound'), require('../model/GetCharactersCharacterIdPortraitOk'), require('../model/GetCharactersCharacterIdRolesOk'), require('../model/GetCharactersCharacterIdStandings200Ok'), require('../model/GetCharactersCharacterIdStats200Ok'), require('../model/GetCharactersCharacterIdTitles200Ok'), require('../model/GetCharactersNames200Ok'), require('../model/InternalServerError'), require('../model/PostCharactersAffiliation200Ok'), require('../model/PostCharactersAffiliationNotFound'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.CharacterApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.Forbidden, root.EveSwaggerInterface.GetCharactersCharacterIdAgentsResearch200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdBlueprints200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdChatChannels200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdCorporationhistory200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdFatigueOk, root.EveSwaggerInterface.GetCharactersCharacterIdMedals200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdNotFound, root.EveSwaggerInterface.GetCharactersCharacterIdNotifications200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdNotificationsContacts200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdOk, root.EveSwaggerInterface.GetCharactersCharacterIdPortraitNotFound, root.EveSwaggerInterface.GetCharactersCharacterIdPortraitOk, root.EveSwaggerInterface.GetCharactersCharacterIdRolesOk, root.EveSwaggerInterface.GetCharactersCharacterIdStandings200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdStats200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdTitles200Ok, root.EveSwaggerInterface.GetCharactersNames200Ok, root.EveSwaggerInterface.InternalServerError, root.EveSwaggerInterface.PostCharactersAffiliation200Ok, root.EveSwaggerInterface.PostCharactersAffiliationNotFound);
  }
}(this, function(ApiClient, Forbidden, GetCharactersCharacterIdAgentsResearch200Ok, GetCharactersCharacterIdBlueprints200Ok, GetCharactersCharacterIdChatChannels200Ok, GetCharactersCharacterIdCorporationhistory200Ok, GetCharactersCharacterIdFatigueOk, GetCharactersCharacterIdMedals200Ok, GetCharactersCharacterIdNotFound, GetCharactersCharacterIdNotifications200Ok, GetCharactersCharacterIdNotificationsContacts200Ok, GetCharactersCharacterIdOk, GetCharactersCharacterIdPortraitNotFound, GetCharactersCharacterIdPortraitOk, GetCharactersCharacterIdRolesOk, GetCharactersCharacterIdStandings200Ok, GetCharactersCharacterIdStats200Ok, GetCharactersCharacterIdTitles200Ok, GetCharactersNames200Ok, InternalServerError, PostCharactersAffiliation200Ok, PostCharactersAffiliationNotFound) {
  'use strict';
