...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetRouteOriginDestinationNotFound', 'model/InternalServerError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GetRouteOriginDestinationNotFound'), require('../model/InternalServerError'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.RoutesApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.GetRouteOriginDestinationNotFound, root.EveSwaggerInterface.InternalServerError);
  }
}(this, function(ApiClient, GetRouteOriginDestinationNotFound, InternalServerError) {
  'use strict';
