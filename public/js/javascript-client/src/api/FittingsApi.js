...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Forbidden', 'model/GetCharactersCharacterIdFittings200Ok', 'model/InternalServerError', 'model/PostCharactersCharacterIdFittingsCreated', 'model/PostCharactersCharacterIdFittingsFitting'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Forbidden'), require('../model/GetCharactersCharacterIdFittings200Ok'), require('../model/InternalServerError'), require('../model/PostCharactersCharacterIdFittingsCreated'), require('../model/PostCharactersCharacterIdFittingsFitting'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.FittingsApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.Forbidden, root.EveSwaggerInterface.GetCharactersCharacterIdFittings200Ok, root.EveSwaggerInterface.InternalServerError, root.EveSwaggerInterface.PostCharactersCharacterIdFittingsCreated, root.EveSwaggerInterface.PostCharactersCharacterIdFittingsFitting);
  }
}(this, function(ApiClient, Forbidden, GetCharactersCharacterIdFittings200Ok, InternalServerError, PostCharactersCharacterIdFittingsCreated, PostCharactersCharacterIdFittingsFitting) {
  'use strict';
