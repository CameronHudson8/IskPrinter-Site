...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DeleteCharactersCharacterIdMailLabelsLabelIdUnprocessableEntity', 'model/Forbidden', 'model/GetCharactersCharacterIdMail200Ok', 'model/GetCharactersCharacterIdMailLabelsOk', 'model/GetCharactersCharacterIdMailLists200Ok', 'model/GetCharactersCharacterIdMailMailIdNotFound', 'model/GetCharactersCharacterIdMailMailIdOk', 'model/InternalServerError', 'model/PostCharactersCharacterIdMailBadRequest', 'model/PostCharactersCharacterIdMailLabelsLabel', 'model/PostCharactersCharacterIdMailMail', 'model/PutCharactersCharacterIdMailMailIdBadRequest', 'model/PutCharactersCharacterIdMailMailIdContents'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DeleteCharactersCharacterIdMailLabelsLabelIdUnprocessableEntity'), require('../model/Forbidden'), require('../model/GetCharactersCharacterIdMail200Ok'), require('../model/GetCharactersCharacterIdMailLabelsOk'), require('../model/GetCharactersCharacterIdMailLists200Ok'), require('../model/GetCharactersCharacterIdMailMailIdNotFound'), require('../model/GetCharactersCharacterIdMailMailIdOk'), require('../model/InternalServerError'), require('../model/PostCharactersCharacterIdMailBadRequest'), require('../model/PostCharactersCharacterIdMailLabelsLabel'), require('../model/PostCharactersCharacterIdMailMail'), require('../model/PutCharactersCharacterIdMailMailIdBadRequest'), require('../model/PutCharactersCharacterIdMailMailIdContents'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.MailApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.DeleteCharactersCharacterIdMailLabelsLabelIdUnprocessableEntity, root.EveSwaggerInterface.Forbidden, root.EveSwaggerInterface.GetCharactersCharacterIdMail200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdMailLabelsOk, root.EveSwaggerInterface.GetCharactersCharacterIdMailLists200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdMailMailIdNotFound, root.EveSwaggerInterface.GetCharactersCharacterIdMailMailIdOk, root.EveSwaggerInterface.InternalServerError, root.EveSwaggerInterface.PostCharactersCharacterIdMailBadRequest, root.EveSwaggerInterface.PostCharactersCharacterIdMailLabelsLabel, root.EveSwaggerInterface.PostCharactersCharacterIdMailMail, root.EveSwaggerInterface.PutCharactersCharacterIdMailMailIdBadRequest, root.EveSwaggerInterface.PutCharactersCharacterIdMailMailIdContents);
  }
}(this, function(ApiClient, DeleteCharactersCharacterIdMailLabelsLabelIdUnprocessableEntity, Forbidden, GetCharactersCharacterIdMail200Ok, GetCharactersCharacterIdMailLabelsOk, GetCharactersCharacterIdMailLists200Ok, GetCharactersCharacterIdMailMailIdNotFound, GetCharactersCharacterIdMailMailIdOk, InternalServerError, PostCharactersCharacterIdMailBadRequest, PostCharactersCharacterIdMailLabelsLabel, PostCharactersCharacterIdMailMail, PutCharactersCharacterIdMailMailIdBadRequest, PutCharactersCharacterIdMailMailIdContents) {
  'use strict';
