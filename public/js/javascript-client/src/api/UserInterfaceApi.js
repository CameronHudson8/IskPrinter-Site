...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Forbidden', 'model/InternalServerError', 'model/PostUiOpenwindowNewmailNewMail', 'model/PostUiOpenwindowNewmailUnprocessableEntity'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Forbidden'), require('../model/InternalServerError'), require('../model/PostUiOpenwindowNewmailNewMail'), require('../model/PostUiOpenwindowNewmailUnprocessableEntity'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.UserInterfaceApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.Forbidden, root.EveSwaggerInterface.InternalServerError, root.EveSwaggerInterface.PostUiOpenwindowNewmailNewMail, root.EveSwaggerInterface.PostUiOpenwindowNewmailUnprocessableEntity);
  }
}(this, function(ApiClient, Forbidden, InternalServerError, PostUiOpenwindowNewmailNewMail, PostUiOpenwindowNewmailUnprocessableEntity) {
  'use strict';
