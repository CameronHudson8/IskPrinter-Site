...
curl \
    ...
    | jq -r '.link' \
    | xargs curl -o backend/lib/client-generated.zip
unzip backend/lib/client-generated.zip  -d backend/lib
rm backend/lib/client-generated.zip

# # Install dependencies
composer update -d "backend/lib/php-client/SwaggerClient-php"
composer install -d "backend/lib/php-client/SwaggerClient-php"
composer update -d "backend"
